                        ...
                        <div class="col all_content">
                            <div class="card h-100 shadow-lg border-0  mb-5 p-0 rounded">
                                <div class="position-relative">
                                    <form action="{{ Route('home.folow', $event->event->slug) }}" method="post"
                                        data-id="{{ $event->event->id }}" class="event_folow">
                                        @csrf
                                ...
                                <div class="card-body ">
                                    ...
                                    <p class="card-text">
                                        {{ strlen($event->event->description) > 200 ? substr($event->event->description, 0, 200) . ' ...' : $event->description }}
                                    </p>
                                </div>
                                <div class="text-center">
